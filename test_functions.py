...
def test_adjacent_2():
    ...
    assert game_functions.check_adjacent(x=0, y=6, board=test_grid, p=1) == 1
...
def test_adjacent_3():
    ...
    assert game_functions.check_adjacent(x=4, y=2, board=test_grid, p=2) == 1
